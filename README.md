...
- `tests/`: plain-assertion harnesses (console, no xUnit): `Slice` (28 assertions),
  `EngineHarness` (70), `ResearcherHarness` (30), `HookHarness` (13), `StoreParityHarness` (17),
  `GatewayGateHarness` (34), `DispatcherNoSendHarness` (25), `LifecycleHarness` (37), and
  `RendererHarness` (6). Latest offline total: 260 assertions. Run each with
