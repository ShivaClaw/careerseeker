...
- `tests/`: plain-assertion harnesses (console, no xUnit): `Slice` (28 assertions),
  `EngineHarness` (103), `ResearcherHarness` (55), `HookHarness` (14), `StoreParityHarness` (22),
  `GatewayGateHarness` (34), `DispatcherNoSendHarness` (35), `LifecycleHarness` (44),
  `RendererHarness` (6), and `SyncHarness` (94). Latest offline total: 435 assertions. Run each with
