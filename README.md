...
- `tests/`: plain-assertion harnesses (console, no xUnit): `Slice` (28 assertions),
  `EngineHarness` (118), `ResearcherHarness` (55), `HookHarness` (14), `StoreParityHarness` (25),
  `GatewayGateHarness` (34), `DispatcherNoSendHarness` (35), `LifecycleHarness` (44),
  `RendererHarness` (6), and `SyncHarness` (130). Latest offline total: 489 assertions. Run each with
