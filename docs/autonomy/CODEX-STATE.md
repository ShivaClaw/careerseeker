...
| R5 | IN PROGRESS | Repository-only changelog, preservation-first migration guide, and truthful download Markdown/HTML are implemented. Import preview executed without import or overwrite. Offline/full gates are 412/0, analyzers 0/0, and the package self-check is green; PR/CI/merge remain before DONE. |
