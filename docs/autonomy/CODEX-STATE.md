...
| R6 | IN PROGRESS | R6(a) is complete on PR #25. R6(b) adds a byte-validated nine-package SPDX 2.3 snapshot (SHA-256 `A82CE68…D71E`), dated NuGet advisory evidence with zero reported entries, and Q06 runtime/site/license-review backstops while keeping D08 UNPROVEN. Offline/full gates pass at 418/0 with analyzers 0/0 and a one-executable package self-check. R6(c) PSScriptAnalyzer and R6(d) backlog review remain. |
