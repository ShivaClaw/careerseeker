...
| P03 | “CareerSeeker ranks jobs against your local source-of-truth profile.” | PROVEN | Job-side lexical coverage is non-decreasing across nested 10/50/200-term profiles; an empty profile has zero CV-match evidence and cannot make a posting act-eligible. Calibration, explanation, persistence, and dashboard assertions pass. | `src/Engine/LexicalSemanticScorer.cs:48`, `tests/EngineHarness/Program.cs:1066`, `docs/Scoring-Calibration.md` |
