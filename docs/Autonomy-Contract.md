...
| Export audit log or local evidence bundle | Available through the local `export-audit` and `export-alpha-package` commands; audit-chain verification is implemented in the store and harnesses. |
