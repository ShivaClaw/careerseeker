...
| Count/docs/verifier moved together to 397. | `powershell -ExecutionPolicy Bypass -File scripts\Verify-Alpha.ps1` | Expected exact-tip result: `Offline total: 397 passed, 0 failed`. |
