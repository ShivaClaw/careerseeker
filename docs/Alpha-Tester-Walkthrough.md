...
Double-click `Uninstall-CareerSeeker-DashboardTask.cmd` to remove that logon task.
...
- The optional dashboard logon task is per-user and removable with `Uninstall-CareerSeeker-DashboardTask.cmd`.
