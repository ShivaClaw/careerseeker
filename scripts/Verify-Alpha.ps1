...
Invoke-Step "Public README and harness count smoke" {
    ...
    Assert-Contains $readme @(
        ...
        'Latest offline total: 260 assertions'
    ) "README.md"
    ...
    Assert-Contains $summary @(
        ...
        '| `EngineHarness` | 70 passed, 0 failed |',
        '`/evidence.html`',
    ...
    Assert-Contains $engineReadme @(
        'Latest offline harness total: 260 passed, 0 failed.',
    ...
    Assert-Contains $handoff @(
        'Latest local offline verifier: `260 passed, 0 failed`.',
    ...
    Assert-Contains $historicalAudit @(
        ...
        'the default verifier reports 260 passed / 0 failed'
