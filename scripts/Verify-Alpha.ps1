...
Invoke-Step "Public README and harness count smoke" {
    ...
    Assert-Contains $readme @(
        ...
        'Latest offline total: 294 assertions'
    ) "README.md"
    ...
    Assert-Contains $summary @(
        ...
        '| `EngineHarness` | 86 passed, 0 failed |',
    ...
    Assert-Contains $engineReadme @(
        'Latest offline harness total: 294 passed, 0 failed.',
    ...
    Assert-Contains $handoff @(
        'Latest local offline verifier: `294 passed, 0 failed`.',
    ...
    Assert-Contains $historicalAudit @(
        ...
        'the default verifier reports 294 passed / 0 failed'
