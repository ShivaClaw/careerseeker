...
Invoke-Step "Public README and harness count smoke" {
    ...
    Assert-Contains $readme @(
        ...
        'Latest offline total: 261 assertions'
    ) "README.md"
    ...
    Assert-Contains $engineReadme @(
        'Latest offline harness total: 261 passed, 0 failed.',
    ...
    Assert-Contains $handoff @(
        'Latest local offline verifier: `261 passed, 0 failed`.',
    ...
    Assert-Contains $historicalAudit @(
        ...
        'the default verifier reports 261 passed / 0 failed'
