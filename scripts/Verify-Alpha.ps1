...
Invoke-Step "Public README and harness count smoke" {
    ...
    Assert-Contains $readme @(
        ...
        'EngineHarness` (76)',
        'ResearcherHarness` (33)',
        'GatewayGateHarness` (34)',
        'admitted hooks stay prompt',
        'Latest offline total: 269 assertions'
    ) "README.md"
    ...
    Assert-Contains $engineReadme @(
        'Latest offline harness total: 269 passed, 0 failed.',
    ...
    Assert-Contains $handoff @(
        'Latest local offline verifier: `269 passed, 0 failed`.',
        ...
        'Source-of-truth profile import replaces the claim oracle and refuses non-alpha profile artifacts or duplicate claim ids',
    ...
    Assert-Contains $historicalAudit @(
        ...
        'the default verifier reports 269 passed / 0 failed'
