...
"@
    ...
    $manifest = [ordered]@{
        ...
        includes = [ordered]@{
            ...
            launchers = @("Setup-CareerSeeker-Alpha.cmd", "Import-CareerSeeker-Profile.cmd", "Connect-CareerSeeker-Providers.cmd", "Connect-CareerSeeker-Gmail.cmd", "Start-CareerSeeker-Alpha.cmd")
