...
public sealed class BudgetMeter
{
    ...
    public decimal SpentUsd => _spent;
    public decimal RemainingUsd => Math.Max(0m, _capUsd - _spent);
    public decimal Fraction => _capUsd == decimal.MaxValue ? 0m : _spent / _capUsd;
